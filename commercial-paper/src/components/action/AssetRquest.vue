 ...
 * @FilePath: \commercial-paper\src\components\AssetRquest.vue
 * @Description: 发起请求
-->
...
<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="资产摘要：" prop="assetHash">
        <el-input v-model="form.assetHash" clearable />
      </el-form-item>
      <el-form-item label="资产类型：" prop="assetType">
        <el-input v-model="form.assetType" clearable />
      </el-form-item>
      <el-form-item label="资产名称 ：" prop="assetName">
        <el-input v-model="form.assetName" clearable />
      </el-form-item>
      <el-form-item label="请求说明 ：" prop="ext">
        <el-input v-model="form.ext" clearable />
      </el-form-item>
      <el-form-item label="背书人数 ：" prop="endorserNum">
        <el-input v-model="form.endorserNum" clearable />
      </el-form-item>
    </el-form>
    <template #footer>
...
const rules = {
  ...
  assetHash: [{ required: true, message: "请输入资产摘要", trigger: "blur" }],
  ext: [{ required: true, message: "请输入请求说明", trigger: "blur" }],
  endorserNum: [
    { required: true, message: "请输入背书人数量", trigger: "blur" },
  ],
};
// 表单提交
