 ...
 * @LastEditTime: 2022-11-28 22:41:07
 * @FilePath: \commercial-bill\src\components\PageAccount.vue
 * @Description: 当前账户
-->
<template>
  <el-form-item label="当前账户:">
    ...
    >
      <el-option
        ...
        :value="item.value"
      >
        <el-tooltip effect="light" :content="item.label" placement="left-start">
